...
def check_overlap(left_start: int, right_start: int, left_end: int, right_end: int) -> bool:
...
with open("input.txt", "r") as input_file:
    ...
    for line in lines:
        ...
        if check_overlap(left_start, right_start, left_end, right_end) or \
            check_overlap(right_start, left_start, right_end, left_end):
            total_overlaps += 1
